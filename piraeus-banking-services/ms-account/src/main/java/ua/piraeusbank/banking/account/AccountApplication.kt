...
import ua.piraeusbank.banking.common.config.BootstrapPersistenceConfig
...
@Import(BootstrapPersistenceConfig::class, MessagingConfig::class, ResourceServerConfig::class)
